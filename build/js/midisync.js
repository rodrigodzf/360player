    ...
    var midiSync = {
        ...
        initMidi: function() {
            navigator.requestMIDIAccess().then(function(info) {
                $('midi_input_device_select').on('change', function(e) {
                ...
                info.inputs.forEach(function(input, id) {
                    ...
                    $('midi_input_device_select').append(opt);
                });
            ...
            if (!bStopped){
                ...
                if(bNewFrame) {
                    if (iDelay >= 2){
                        ...
                        if (bNewStart){
                            this.seekTo(times[kMTCFrames]/24 + times[kMTCSeconds]);
                            // video.currentTime = times[kMTCFrames]/24 + times[kMTCSeconds];
                            // console.log(video.currentTime);
                            // controls.play();
                            bNewStart = false;
