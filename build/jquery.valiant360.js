/*! jquery.valiant360 - v0.3.0 - 2015-10-14
 * http://flimshaw.github.io/Valiant360
 * Copyright (c) 2015 Charlie Hoey <me@charliehoey.com>; Licensed MIT */
...
;(function ( $, THREE, Detector, window, document, undefined ) {
    ...
    Plugin.prototype = {
        ...
        createControls: function() {
            ...
            var playPauseControl = this.options.autoplay ? 'fa-play' : 'fa-pause';

            // Check if we actually need the midi input box
            var controlsHTML = ' \
                <div class="controls"> \
                    ...
                    <a href="#" class="folderOpen button fa fa-folder-open"></a> \
                    <select id="midi_input_device_select" class="rfloat"></select> \
                </div> \
            ';
        ...
        attachControlEvents: function() {
            ...
            $(window).resize(function() {
                ...
                self.resizeGL($(self.element).width(), $(self.element).height());
                // console.log($(self.element).width());
            });
            ...
            input.on("change", function(){
                ...
                if (!input.prop('files')[0]) {
                    ...
                    // !Only electron based method
                    console.log(file.path);
                    self.unloadVideo();
                    self.loadVideo(file.path);
            ...
            /*folder open*/
            $(this.element).find('.folderOpen').click(function(e) {
                e.preventDefault();
        ...
        loadVideo: function(vf) {
            // vf = $(vf).attr('data-video-src');
            // videoFile = 'build/WM-Goal_Clean.mp4'
            console.log(vf);
            this._video.src = vf;
            this._video.play();
        },
        unloadVideo: function() {
            ...
            this.pause();
            this._video.src = '';
            this._video.removeAttribute('data-video-src');
        },
    ...
    $.fn[pluginName] = function ( options, opt ) {
        return this.each(function () {
            if(typeof options === 'object' || !options) {
                ...
                return this.plugin[options].apply(this.plugin, [opt]);
            }
        });
    };
